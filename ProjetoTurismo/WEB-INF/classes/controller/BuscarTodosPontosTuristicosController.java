...
/**
 * Servlet implementation class BuscarTodosPontosTuristicosController
 */
public class BuscarTodosPontosTuristicosController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BuscarTodosPontosTuristicosController() {
        super();
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		List<PontoTuristico> listaPontosTuristicos = pts.buscarTodosPontosTuristicos();
