...
/**
 * Servlet implementation class BuscarEmpresaPorParteDoNome
 */
public class BuscarEmpresaPorParteDoNome extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public BuscarEmpresaPorParteDoNome() {
        super();
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		if(nome.length()>0){
			...
			List<Empresa> listaEmpresas = es.buscarEmpresaPorParteDoNome(nome);
