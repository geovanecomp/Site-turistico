...
/**
 * Servlet implementation class UploadFilePontoTuristicoController
 */
public class UploadFilePontoTuristicoController extends HttpServlet {
	private static final long serialVersionUID = 1L;
       
    /**
     * @see HttpServlet#HttpServlet()
     */
    public UploadFilePontoTuristicoController() {
        super();
		   ...
		   boolean isMultipart = ServletFileUpload.isMultipartContent(request);
		    if (!isMultipart) {
			  ...
			  dispatcher.forward(request,response);
			      ...
			      RequestDispatcher dispatcher = request.getRequestDispatcher("cadastrarPontoTuristico.jsp");
				  dispatcher.forward(request,response);
